...
public class Servicio {
    ...
    private final String nombreArchivo = "donantes.txt";
    private static Servicio instance;
    private Context context;

    private Servicio (Context context) throws ClassNotFoundException, IOException{
        try {
    ...
    public static Servicio getInstance(Context context) throws IOException, ClassNotFoundException {
        if (instance == null)
            instance = new Servicio(context);
        return instance;
    }
